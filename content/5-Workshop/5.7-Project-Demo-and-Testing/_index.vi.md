...
![Màn hình đăng nhập IRMS](/images/5-Workshop/IRMS-demo-test/demo-test-06.png)

Sau khi đăng nhập, kiểm tra dashboard hiển thị các thẻ trạng thái incident, recent incidents và security posture.

![Dashboard IRMS](/images/5-Workshop/IRMS-demo-test/demo-test-07.png)
...
![Tạo incident mới](/images/5-Workshop/IRMS-demo-test/demo-test-09.png)

Submit form và kiểm tra incident vừa tạo xuất hiện trong danh sách.

![Tạo incident thành công](/images/5-Workshop/IRMS-demo-test/demo-test-10.png)

Mở trang chi tiết incident và kiểm tra status, severity, assignee, timeline và evidence panel.

![Chi tiết incident](/images/5-Workshop/IRMS-demo-test/demo-test-11.png)

Thêm một timeline entry cho giai đoạn investigating hoặc containment.

![Thêm timeline entry](/images/5-Workshop/IRMS-demo-test/demo-test-12.png)

![Timeline entry đã lưu](/images/5-Workshop/IRMS-demo-test/demo-test-13.png)
...
![Form upload evidence](/images/5-Workshop/IRMS-demo-test/demo-test-14.png)

Frontend tự nhận diện tên file, MIME type và dung lượng file trước khi upload.

![Thông tin evidence](/images/5-Workshop/IRMS-demo-test/demo-test-15.png)
...
![Evidence object trong S3](/images/5-Workshop/IRMS-demo-test/demo-test-17.png)

Xác minh metadata tương ứng trong DynamoDB.

![Evidence metadata trong DynamoDB](/images/5-Workshop/IRMS-demo-test/demo-test-18.png)
...
![Trang AI Assistant](/images/5-Workshop/IRMS-demo-test/demo-test-19.png)

Chọn incident vừa tạo để phân tích.

![Chọn incident cho AI analysis](/images/5-Workshop/IRMS-demo-test/demo-test-20.png)

Xem kết quả phân tích có cấu trúc.

![Kết quả AI Analyst](/images/5-Workshop/IRMS-demo-test/demo-test-21.png)
...
![Chế độ AI Chat](/images/5-Workshop/IRMS-demo-test/demo-test-24.png)
...
![Phản hồi AI Chat](/images/5-Workshop/IRMS-demo-test/demo-test-25.png)
