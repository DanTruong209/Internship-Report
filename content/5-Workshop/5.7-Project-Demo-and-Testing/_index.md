...
![IRMS login screen](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-06.png)
...
![IRMS dashboard](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-07.png)
...
![Create new incident](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-09.png)

Submit the form and confirm that the incident appears in the incident list.

![Incident created successfully](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-10.png)

Open the new incident detail page and verify the status, severity, assignment, timeline, and evidence panel.

![Incident detail](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-11.png)

Add an investigation or containment timeline entry.

![Add timeline entry](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-12.png)

![Timeline entry saved](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-13.png)
...
![Evidence upload form](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-14.png)

The frontend detects the file name, MIME type, and file size before upload.

![Evidence upload details](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-15.png)
...
![Evidence object in S3](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-17.png)

Verify the metadata item in DynamoDB.

![Evidence metadata in DynamoDB](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-18.png)
...
![AI Assistant page](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-19.png)

Select the incident created during the test.

![Select incident for AI analysis](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-20.png)

Review the structured AI result.

![AI Analyst result](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-21.png)
...
![AI Chat mode](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-24.png)
...
![AI Chat response](///images/5-Workshop/5.2-Prerequisite/IRMS-demo-test/demo-test-25.png)
